...
void Motion::SetPosturesToDefault1()
{
  for (int frame = 0; frame<m_NumFrames; frame++)
  {
	//set root position to (0,0,0)
...
void Motion::SetBoneTranslation(int frameIndex, int boneIndex, vector vRot)
{
	m_pPostures[frameIndex].bone_translation[boneIndex] = vRot;
}
